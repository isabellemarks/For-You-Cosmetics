 ...
 * @author Isabelle
 */
@WebServlet(name = "PesquisarProdutoServlet", urlPatterns = {"/PesquisarProdutoServlet.do"})
public class PesquisarProdutoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PesquisarProdutoServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PesquisarProdutoServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    /**
     * Método responsável por pesquisar os produtos através do nome informado.
     *
     ...
     */
    public String pesquisarProduto(HttpServletRequest request, HttpServletResponse response) {
        String nome = request.getParameter("nome");

        ProdutoDao produtoDao = new ProdutoDao();
        produtoDao.consultarProdutosPorNome(nome);
     ...
     * produtos existentes no banco com o nome solicitado.
     *
    ...
    private int preencheTabela(java.io.PrintWriter out, String nome) throws Exception {
        ...
        ResultSet rs = stmt.executeQuery("SELECT * from Produto WHERE nomeProduto LIKE '" + nome + "%';");
    ...
    public void mostrarPesquisa(HttpServletRequest request, HttpServletResponse response) {
        ...
        String nome = pesquisarProduto(request, response);
        try {
            ...
            try {
                ...
                out.print("<!DOCTYPE html>\n"
                        ...
                        + "    <head>\n"
                        + "        <meta charset=\"utf-8\">\n"
                        + "        <title>Pesquisar Produto | For You Cosmetics</title>\n"
                        ...
                        + "            <strong>Pesquisar Produto</strong></p>\n"
                        + "        <div id=\"form-pesquisar-produto\">\n"
                        + "            <form action=\"PesquisarProdutoServlet.do\" method=\"POST\" accept-charset=\"utf-8\">\n"
                        + "                Nome do produto:\n"
                        ...
                        + "        <br />\n"
                        + "        <br />\n"
                        + "        <div class=\"resultado-pesquisa-produto-tabela\">\n"
                        + "            <table>\n");
