 ...
 * @author Isabelle
 */
@WebServlet(name = "DesativarClienteServlet", urlPatterns = {"/DesativarClienteServlet.do"})
public class DesativarClienteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DesativarClienteServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DesativarClienteServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    /**
     * * Método responsável por pesquisar fazer a desativação de um cliente.
     * Primeiramente ele faz uma consulta pelo seu id e logo após haverá a sua
     * desativação, caso este esteja ativado.
     *
     ...
     * @return ele retornará o id do Cliente.
     */
