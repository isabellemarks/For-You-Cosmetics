 ...
 * @author Isabelle
 */
@WebServlet(name = "PesquisarClientesServlet", urlPatterns = {"/PesquisarClientesServlet.do"})
public class PesquisarClientesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PesquisarClienteServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PesquisarClienteServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    /**
     * Método responsável por pesquisar os clientes através do nome informado.
     *
     ...
     */
    public String pesquisarCliente(HttpServletRequest request, HttpServletResponse response) {
        String nome = request.getParameter("nome");

        ClienteDao clienteDao = new ClienteDao();
        clienteDao.consultarClientePorNome(nome);
     ...
     * clientes existentes no banco com o nome solicitado.
     *
    ...
    private int preencheTabela(java.io.PrintWriter out, String nome) throws Exception {
        ...
        ResultSet rs = stmt.executeQuery("SELECT * from Cliente WHERE nome LIKE '" + nome + "%';");
    ...
    public void mostrarPesquisa(HttpServletRequest request, HttpServletResponse response) {
        PrintWriter out;
        String nome = pesquisarCliente(request, response);
        try {
