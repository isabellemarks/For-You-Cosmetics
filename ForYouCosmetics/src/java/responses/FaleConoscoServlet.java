 ...
 * @author Isabelle
 */
@WebServlet(name = "FaleConoscoServlet", urlPatterns = {"/FaleConoscoServlet.do"})
public class FaleConoscoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FaleConoscoServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FaleConoscoServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    /**
     * Método responsável pela pesquisa de todas as mensagens existentes no
     * banco.
     *
    ...
    /**
     * Método responsável por preencher a tabela com todos os itens encontrados.
     *
